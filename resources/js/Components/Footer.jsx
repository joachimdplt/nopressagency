...
export default function Footer() {
    ...
    const socials = [
        {
            name: 'LinkedIn',
            href: 'https://linkedin.com/in/joachim-d-645aa5180',
            icon: (
        ...
        {
            name: 'Twitter',
            href: 'https://twitter.com/nopress',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: 'Instagram',
            href: 'https://instagram.com/nopress',
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="text-center lg:text-left">
                        ...
                        <a 
                            href="mailto:contact@nopress.wtf"
                            className="text-gray-600 hover:text-blue-600 transition-colors block mb-4"
                        >
                            contact@nopress.wtf
                        </a>
